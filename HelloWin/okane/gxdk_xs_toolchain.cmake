#
# gxdk_xs_toolchain.cmake : CMake toolchain for Microsoft GDK targeting Xbox Series X|S (Gaming.Xbox.Scarlett.x64)
#
...
if(Console_SdkRoot AND XdkEditionTarget)
    if(EXISTS "${Console_SdkRoot}/${XdkEditionTarget}")
        ...
        foreach(t EXE SHARED MODULE)
            string(APPEND CMAKE_${t}_LINKER_FLAGS_INIT " /LIBPATH:\"${_POWER_Console_SdkRootNative}\\${XdkEditionTarget}\\xbox\\lib\\x64\" /LIBPATH:\"${_POWER_Console_SdkRootNative}\\${XdkEditionTarget}\\xbox\\lib\\gen9\"")
        endforeach()
    endif()
endif()
...
set(Console_Defines _UNICODE UNICODE WIN32_LEAN_AND_MEAN _GAMING_XBOX _GAMING_XBOX_SCARLETT WINAPI_FAMILY=WINAPI_FAMILY_GAMES _CRT_USE_WINAPI_PARTITION_APP _UITHREADCTXT_SUPPORT=0 __WRL_CLASSIC_COM_STRICT__ _ATL_NO_DEFAULT_LIBS __WRL_NO_DEFAULT_LIB__)
...
if(NOT GDK_DXCTool)
    find_program(GDK_DXCTool NAMES dxc dxc.exe
        PATHS
            "${Console_SdkRoot}/${XdkEditionTarget}/xbox/bin/gen9"
            "${Console_SdkRoot}/bin/Scarlett/pixsc"
        NO_DEFAULT_PATH)
...
set(_POWER_GXDK_XS_TOOLCHAIN_ ON)
